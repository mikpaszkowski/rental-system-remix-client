    ...
    return (
        <div className="absolute flex flex-col justify-center items-center bg-shadow top-0 left-0 h-screen w-screen">
            <div className="flex flex-col justify-center items-center w-80">
                <input type="text"
                       className="w-full bg-primary h-11 mb-6 rounded-md px-4 text-secondary font-light placeholder:text-secondary"
                       placeholder="Account" onChange={(event) => setCredentials(prevState => {
                    return {
                        ...prevState,
                ...
                <input type="password"
                       className="w-full bg-primary h-11 mb-6 rounded-md px-4 text-secondary font-light placeholder:text-secondary"
                       placeholder="Secret" onChange={(event) => setCredentials(prevState => {
                    return {
                        ...prevState,
